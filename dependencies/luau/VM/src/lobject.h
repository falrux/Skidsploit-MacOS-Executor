...
#include "lua.h"
#include "src/update/update.hpp" // !MODIFICATION
#include "lcommon.h"
...
// clang-format off
#define CommonHeader \
     uint8_t marked; uint8_t tt; uint8_t memcat 
// !MODIFICATION
// clang-format on
...
typedef struct Proto
{
    ...
    uint8_t is_vararg;
    uint8_t nups;
    PROTO_LOCVAR_ENC<struct LocVar*> locvars;
    PROTO_DEBUGISN_ENC<uint8_t*> debuginsn;
    TValue* k;
    Instruction* code;
...
#define luaO_nilobject (TValue*)Offsets::luaO_nilobject // !MODIFICATION
